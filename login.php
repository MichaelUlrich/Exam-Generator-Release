...
//	redirect("studentHomepage.php");
		...
		echo "https://web.njit.edu/~meu3/CS490/Exam-Generator-Release/student/studentHomepage.php";
		exit();
		...
		echo "https://web.njit.edu/~meu3/CS490/Exam-Generator-Release/teacher/teacherHomepage.php";
		exit();
	} else {
	//redirect("login.html");
