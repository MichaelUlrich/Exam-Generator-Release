...
<body>
	...
	<button class="block" onclick="window.location.replace('https://web.njit.edu/~meu3/CS490/Exam-Generator-Release/teacher/selectQuestions.php')"> Select Questions </button><br>
	<!--<button class="block" onclick="window.location.href='test.php'"> Review Test[REMOVE AFTER TESTING] </button><br>-->
	<button class="block" onclick="window.location.replace('https://web.njit.edu/~meu3/CS490/Exam-Generator-Release/teacher/addComments.php')"> Add Comments/Grades </button><br>
</body>
</html>
